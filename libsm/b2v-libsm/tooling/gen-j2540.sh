...
h () {
  ...
  cat <<EOF
Usage: $0 [OPTION]... <J2540.ASN>
Regenerate src/j2540 from ASN using mouse07410/asn1c
...
compileASN "$tmpDir" j2540 "${inputFiles[@]}"

rm -rf "$ROOT/src/j2540"
cp -r "$tmp_dir/output" "$ROOT/src/j2540"
