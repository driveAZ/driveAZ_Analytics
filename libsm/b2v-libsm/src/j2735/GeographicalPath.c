...
static asn_TYPE_member_t asn_MBR_description_9[] = {
	{ ATF_POINTER, 0, offsetof(struct GeographicalPath__description, choice.path),
	...
	{ ATF_POINTER, 0, offsetof(struct GeographicalPath__description, choice.geometry),
	...
	{ ATF_POINTER, 0, offsetof(struct GeographicalPath__description, choice.oldRegion),
