...
static asn_TYPE_member_t asn_MBR_area_4[] = {
	{ ATF_POINTER, 0, offsetof(struct ValidRegion__area, choice.shapePointSet),
	...
	{ ATF_POINTER, 0, offsetof(struct ValidRegion__area, choice.circle),
	...
	{ ATF_POINTER, 0, offsetof(struct ValidRegion__area, choice.regionPointSet),
