...
static asn_TYPE_member_t asn_MBR_snapshot_8[] = {
	{ ATF_POINTER, 0, offsetof(struct ProbeDataManagement__snapshot, choice.snapshotTime),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct ProbeDataManagement__snapshot, choice.snapshotDistance),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
