...
static asn_TYPE_member_t asn_MBR_msgId_4[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct TravelerDataFrame__msgId, choice.roadSignID),
...
static asn_TYPE_member_t asn_MBR_content_16[] = {
	{ ATF_POINTER, 0, offsetof(struct TravelerDataFrame__content, choice.advisory),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct TravelerDataFrame__content, choice.workZone),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_WorkZone,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct TravelerDataFrame__content, choice.genericSign),
	...
	{ ATF_POINTER, 0, offsetof(struct TravelerDataFrame__content, choice.speedLimit),
	...
	{ ATF_POINTER, 0, offsetof(struct TravelerDataFrame__content, choice.exitService),
